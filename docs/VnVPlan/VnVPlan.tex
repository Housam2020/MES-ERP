...
\midrule
\textcolor{red}{Nov 1, 2024} & 1.0 & \textcolor{red}{Initial Draft based on Requirements}\\ % Example Date
Nov 4, 2024 & 1.1 & Housam: Add parts to section 3 (plan)\\
\textcolor{red}{Jan 10, 2025} & \textcolor{red}{1.2} & \textcolor{red}{Revised based on TA feedback: Added specificity to tests, included usability test, added appendix, refined nondynamic plan, updated traceability table.} \\ % Example Date
\bottomrule
\end{tabularx}
