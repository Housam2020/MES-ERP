...
\noindent
\textbf{Overview:}  
Although no specific usability tests were defined in Tests~7--10, we did conduct informal user trials where new users (e.g., club leaders unfamiliar with the system) performed basic tasks such as budget creation and reimbursement submission. Our goal was to gauge ease of navigation, clarity of interface elements, and overall user satisfaction.
...
\begin{itemize}
  ...
  \item Improved concurrency handling in the \texttt{ReimbursementController}, ensuring that read-write locks do not block each other unnecessarily.
\end{itemize}
