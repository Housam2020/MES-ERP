...
\begin{table}[h]
  ...
  \begin{tabular}{|l|c|}
      ...
      Line Coverage & 17.13\% \\
      Approximate Total Percent of Code Covered & 10-20\% \\
...
\begin{itemize}
  ...
  \item \textbf{Form Validation Messages:} Ensured error tooltips and “success”  
    confirmations are correctly displayed.
\end{itemize}

\subsection{Test Case Effectiveness}

Although our automated test suite currently covers around 10-20\% of the code (Table 2),  
