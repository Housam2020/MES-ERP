...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Attributes:} UserID, Name, Email, Role (Student Group Leader, Administrator, Financial Officer), Login Credentials
    ...
    \begin{itemize}
        \item \textbf{Attributes:} RequestID, SubmitterID (links to UserID), Date of Submission, Amount, Status (Submitted, Approved, Rejected, Paid), Attached Receipts
    ...
    \begin{itemize}
        \item \textbf{Attributes:} BudgetID, GroupID (identifies the student group), Total Amount Allocated, Amount Spent, Category (e.g., Event, Travel, Supplies)
    ...
    \item \textbf{Ledger Entity:}
    \begin{itemize}
        \item \textbf{Attributes:} LedgerID, Date of Transaction, GroupID, Amount, Category, ReimbursementRequestID (optional)
        \item \textbf{Relationship:} Each ledger entry corresponds to an individual financial transaction, either linked to a reimbursement request or manually entered by the MES administration.
    \end{itemize}
    
    \item \textbf{Audit Log Entity:}
    \begin{itemize}
        \item \textbf{Attributes:} AuditLogID, Action, PerformedBy (links to UserID), Date and Time, Entity Affected (e.g., ReimbursementRequestID or BudgetID)
        \item \textbf{Relationship:} The audit log tracks all actions related to budget management, reimbursement requests, and financial approvals, ensuring compliance with MES regulations.
    \end{itemize}
\end{itemize}
