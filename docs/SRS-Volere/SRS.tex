...
We propose a web-based finance and accounting system using Typescript, NextJS, React, and Git to address the MES's challenges in managing reimbursement requests for 60 student groups. This system will streamline financial operations by allowing students to submit reimbursement requests with modular receipt uploads, real-time status tracking, and automated notifications. It will also feature live ledger tracking, custom budget creation, and support for multiple approval levels, ensuring transparency and reducing delays in request processing. This solution will enhance operational efficiency, lowering the wait times and minimizing the risk of lost requests. Typescript will be used as the primary programming language, providing strong typing and error checking to prevent bugs during development. NextJS will serve as the framework for both front-end and back-end, enabling efficient routing and server-side rendering. React will handle the dynamic, component-based user interface, creating a responsive and interactive experience for tasks like budget management and reimbursement tracking. Git will manage version control, allowing the development team to share code, track changes, and collaborate efficiently without overwriting each other’s work. This ensures smooth teamwork and consistent progress throughout the development lifecycle.
