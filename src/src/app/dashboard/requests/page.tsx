...
export default function RequestsPage() {
  ...
  if (permissionsError) return <div>Error loading permissions: {permissionsError.message}</div>;
      ...
      <div className="container mx-auto p-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            {(permissions.includes('create_requests') || permissions.includes('view_all_requests')) && (
              <Link href="/forms">
