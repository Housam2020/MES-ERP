...
const BudgetForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      {/* DashboardHeader remains at the top */}
      <DashboardHeader />

      {/* Main content starts below the header; reduced top padding to pt-8 */}
      <main className="pt-8 p-6">
        <div className="relative max-w-7xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          {/* Home Icon in the top right of the form container */}
          <button
            onClick={() => router.push("/dashboard/home")}
            className="absolute top-4 right-4 p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700"
            aria-label="Go to Home"
          >
            {/* Insert your Home icon here if needed */}
          </button>
